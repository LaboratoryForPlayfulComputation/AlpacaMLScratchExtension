...
const isExpectAssertionsOrHasAssertionsCall = expression => {
  if (expression.type !== _experimentalUtils.AST_NODE_TYPES.CallExpression || expression.callee.type !== _experimentalUtils.AST_NODE_TYPES.MemberExpression || !(0, _tsUtils.isSupportedAccessor)(expression.callee.object, 'expect') || !(0, _tsUtils.isSupportedAccessor)(expression.callee.property)) {
    return false;
  }

  const expectAssertionName = (0, _tsUtils.getAccessorValue)(expression.callee.property);
