  ...
  create(context) {
    ...
    return {
      CallExpression(node) {
        ...
        if ((0, _tsUtils.isTestCase)(node) && describeNestingLevel === 0 && !nodeName.includes(testKeyword)) {
        ...
        if ((0, _tsUtils.isTestCase)(node) && describeNestingLevel > 0 && !nodeName.includes(testKeywordWithinDescribe)) {
