  ...
  create(context) {
    ...
    return {
      CallExpression(node) {
        ...
        if (!argument || !(0, _tsUtils.isStringNode)(argument) || (0, _tsUtils.isTemplateLiteral)(argument) && argument.expressions.length > 0) {
          return;
        }

        const title = (0, _tsUtils.getAccessorValue)(argument);
